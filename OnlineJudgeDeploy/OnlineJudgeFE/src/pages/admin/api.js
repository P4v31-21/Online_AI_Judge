...
export default {
  ...
  getGuardReviewList (params) {
    return ajax('admin/guard-review/', 'get', {
      params
    })
  },
  guardReview (data) {
    return ajax('admin/guard-review/', 'post', {
      data
    })
  },
  getSessions () {
  ...
  generateProblemByAI (data) {
    return ajax('ai/generate-problem', 'post', {
      data
    })
  },
  generateProblemsBatch (data) {
    return ajax('ai/generate-problems-batch', 'post', {
      data: {
        requests: data
      }
    })
  },
  regenerateProblem (data) {
    return ajax('ai/regenerate', 'post', {
      data
    })
  },
  getMyDrafts (page = 1, limit = 10) {
    return ajax('ai/my-drafts', 'get', {
      params: {
        offset: (page - 1) * limit,
        limit
      }
  ...
  saveDraftProblem (data) {
    return ajax('ai/save-problem', 'post', {
      data
    })
  }
}
