<template>
  <el-menu class="vertical_menu"
    ...
    <el-submenu index="problem" v-if="hasProblemPermission">
      ...
      <el-menu-item index="/problem/ai_create">
        <i class="el-icon-fa-magic"></i>AI 出题
      </el-menu-item>
      <el-menu-item index="/ai-drafts">
        <i class="el-icon-fa-file-text-o"></i>我的草稿
      </el-menu-item>
      <el-menu-item index="/guard-review">
        <i class="el-icon-fa-shield"></i>Guard 审核
      </el-menu-item>
