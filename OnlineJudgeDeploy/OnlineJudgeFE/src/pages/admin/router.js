  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/problem/ai_create',
          name: 'ai-create-problem',
          component: () => import('./views/problem/AiCreateProblem.vue')
        },
        {
          path: '/ai-drafts',
          name: 'ai-drafts',
          component: () => import('./views/problem/MyDrafts.vue')
        },
        {
